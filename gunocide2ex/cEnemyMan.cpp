...
bool cEnemyMan::load()
{
	...
	//falls es fehlschl�gt eine Grafik zu laden, gehen wir direkt raus!
	for(int i=0;i<7;i++)
	{
...
///ich gehe �ber den Pointer so das der Desktrutor bzw. Konstruktur
///f�r mich die Initialisierung und so weiter...anders ist's zu umst�ndlich ;)
...
///das Array an Gegnern aus dem Speicher l�schen
...
///die Adresse eines bestimmten Enemy-Objektes zur�ckgeben
cEnemy* cEnemyMan::getenemy(int index)
{
	return &pEnemy[index];
}

///gibt das Kollisionsrechtecke f�r einen Gegner zur�ck
...
///geht alle Gegner durch und gibt ein true zur�ck wenn alle gegner
...
/************************************************************************
Variablen f�r die Energie der Gegner
*************************************************************************/
